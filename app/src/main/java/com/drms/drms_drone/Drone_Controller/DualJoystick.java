            ...
            switch (v.getId()) {
                ...
                case R.id.mag_calibration :
                    if(event.getAction() == MotionEvent.ACTION_DOWN){
                        ...
                        AlertDialog.Builder dialog2 = new AlertDialog.Builder(DualJoystick.this);
                        LinearLayout tream_layout = (LinearLayout)View.inflate(DualJoystick.this,R.layout.tream_dialog,null);
