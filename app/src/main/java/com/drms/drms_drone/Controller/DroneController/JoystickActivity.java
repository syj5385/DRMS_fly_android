...
//        mJoystick = new Joystick1_view(this,this,JoystickHandler);
        if(!mspdata.isControllerConnected()) {
            ...
            mDrsControllerView = new DrsControllerView(this,this,JoystickHandler);
            mDrsControllerView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
            joystick_layout.addView(mDrsControllerView);
        }
    ...
    private final ServiceConnection BTConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName arg0, IBinder arg1) {
            ...
            if(!mspdata.isControllerConnected()) {
                ...
                if(mDrsControllerView != null){
                    mDrsControllerView.setmBluetoothService(mBTService.getmBluetoothService());
                }
            }
...
//            mspdata.setRawRCDataAux(4,2000);
        ...
        Log.d(TAG,"start on");
        if(mDualJoystickView != null)
            mDualJoystickView.startStreamingVideo();
    }
...
//        },1000)
        if(mDualJoystickView != null)
            mDualJoystickView.stopStreamingVideo();
    ...
    private BroadcastReceiver JoystickReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(action.equals(BTService.NEXT_DISPLAY)){

            }
            if (action.equals(BTService.PREVIOUS_DISPLAY)) {
                finish();
            }
        }
    };
